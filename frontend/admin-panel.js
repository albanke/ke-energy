(function(){
  ...
  async function login(username, password){
    ...
    // Evita "login fasullo" quando il frontend punta al server sbagliato
    // (es. Static Site che risponde con HTML/redirect al posto del JSON atteso)
    if(!data || !data.token){
      throw new Error('Login non valido: risposta server non corretta (token mancante). Controlla la variabile ke-api-base.');
    }
