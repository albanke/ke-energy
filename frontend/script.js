...
if (!rows.length) console.warn('Nessun prodotto presente: nascondo le categorie vuote');
...
for (const cat of CATEGORIES) {
  ...
  // Il titolo <h2> è il blocco subito prima del contenitore
